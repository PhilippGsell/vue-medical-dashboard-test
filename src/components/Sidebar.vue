<template>
  <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:left-0 h-screen lg:block bg-gray-100 border-r z-50"
    ...
    <div class="w-full h-20 border-b flex px-4 items-center mb-8">
      <p class="font-semibold text-3xl  pl-4">
        <svg width="160" height="160" fill="currentColor" class="bi fill-current h-12 w-12 text-red-500"
          viewBox="0 0 20 20">
          <path
    ...
    <div class="mb-4 px-4">
      ...
      <div
        class="w-full flex items-center text-red-500 h-10 pl-4 bg-gray-200 hover:bg-gray-200 rounded-lg cursor-pointer">
      ...
      <div class="w-full flex items-center text-red-300 h-10 pl-4 hover:bg-gray-200 rounded-lg">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
    ...
    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">Samples</p>
      <div class="w-full flex items-center text-red-300 h-10 pl-4 hover:bg-gray-200 rounded-lg">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
        ...
        <span class="text-gray-400">Add Sample</span>
      </div>
      <div class="w-full flex items-center text-red-300 h-10 pl-4 hover:bg-gray-200 rounded-lg">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
        ...
        <span class="text-gray-400">View Samples</span>
      </div>
    </div>
