            ...
            <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <div class="inline-block lg:hidden flex items-center mr-4">
                  <button class="hover:text-red-500 hover:border-white focus:outline-none navbar-burger" @click="toggleSidebar()">
              ...
              <div class="flex items-center relative">
               <img src="https://images.unsplash.com/photo-1617791636474-cad64fefa7f7?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=254" class="w-12 h-12 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
              </div>
